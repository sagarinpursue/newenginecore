DROP FUNCTION IF EXISTS public.cx_report_messages_with_issues_total_items_get(text, text, timestamp with time zone, timestamp with time zone, int, int);

CREATE OR REPLACE FUNCTION cx_report_messages_feedbacks_total_items_get(
    channel_filter TEXT,
    account_filter TEXT,
    search_filter TEXT,
